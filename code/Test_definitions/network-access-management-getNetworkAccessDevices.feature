Feature: CAMARA Network Access Management API, v0.2.0-alpha.1 - Operation getNetworkAccessDevices
  ...
  Background: Common getNetworkAccessDevices setup
    ...
    And the resource "/network-access-management/v0.2alpha1/network-access-devices"
