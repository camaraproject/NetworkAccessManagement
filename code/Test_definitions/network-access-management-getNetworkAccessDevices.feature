Feature: CAMARA Network Access Management API, v0.3.0-rc.1 - Operation getNetworkAccessDevices
  ...
  Background: Common getNetworkAccessDevices setup
    ...
    And the resource "/network-access-management/v0.3rc1/network-access-devices"
