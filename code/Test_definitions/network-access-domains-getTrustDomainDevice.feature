Feature: CAMARA Network Access Domains API, v0.3.0-rc.1 - Operation getTrustDomainDevice
  ...
  @network_access_domains_getTrustDomainDevice_01_get_by_id_success @basic_tier
  ...
  @network_access_domains_getTrustDomainDevice_401_01_no_authorization_header @full_tier @requires_oidc
