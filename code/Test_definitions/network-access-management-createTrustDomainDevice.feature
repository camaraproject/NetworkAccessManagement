  @basic_tier
Feature: CAMARA Network Access Management API, v0.2.0-alpha.1 - Operation createTrustDomainDevice
  ...
  Background: Common createTrustDomainDevice setup
    ...
    And the resource "/network-access-management/v0.2alpha1/trust-domains/{trustDomainId}/devices"
