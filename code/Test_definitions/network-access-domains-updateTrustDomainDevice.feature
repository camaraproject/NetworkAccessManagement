  @basic_tier
Feature: CAMARA Network Access Domains API, v0.3.0-rc.1 - Operation updateTrustDomainDevice
  ...
  #
  # Tagging:
  # - @network_access_domains_updateTrustDomainDevice_NN_<slug>  unique scenario id
  ...
  Background: Common updateTrustDomainDevice setup
    ...
    And the resource "/network-access-domains/v0.3rc1/trust-domains/{trustDomainId}/devices/{deviceId}"
  ...
  @network_access_domains_updateTrustDomainDevice_01_rename_success
  ...
  @network_access_domains_updateTrustDomainDevice_02_replace_credential_success
