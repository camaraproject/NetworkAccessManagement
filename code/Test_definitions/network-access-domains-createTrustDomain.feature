Feature: CAMARA Network Access Domains API, vwip - Operation createTrustDomain
  # Reference:
  # - API spec: https://github.com/camaraproject/NetworkAccessManagement/blob/main/code/API_definitions/network-access-domains.yaml
  ...
  Background: Common createTrustDomain setup
    ...
    And the resource "/network-access-domains/vwip/trust-domains"
  ...
  @network_access_domains_createTrustDomain_01_wpa2_personal_success @basic_tier
  ...
  @network_access_domains_createTrustDomain_02_inferred_ssid_success @basic_tier
  ...
  @network_access_domains_createTrustDomain_05_ephemeral_success @basic_tier
  ...
  @network_access_domains_createTrustDomain_400_01_no_request_body @full_tier
  ...
  @network_access_domains_createTrustDomain_400_02_empty_request_body @full_tier
  ...
  @network_access_domains_createTrustDomain_400_03_missing_required_property @full_tier
  ...
  @network_access_domains_createTrustDomain_400_04_invalid_access_type @full_tier
  ...
  @network_access_domains_createTrustDomain_400_06_invalid_service_id_format @full_tier
  ...
  @network_access_domains_createTrustDomain_400_07_empty_access_details @full_tier
  ...
  @network_access_domains_createTrustDomain_400_08_invalid_expiration @full_tier
  ...
  @network_access_domains_createTrustDomain_401_01_no_authorization_header @full_tier @requires_oidc
  ...
  @network_access_domains_createTrustDomain_401_02_expired_token @full_tier @requires_oidc
  ...
  @network_access_domains_createTrustDomain_401_03_malformed_token @full_tier @requires_oidc
  ...
  @network_access_domains_createTrustDomain_403_01_missing_scope @full_tier @requires_oidc
  Scenario: Access token does not include the network-access-domains:trust-domains scope
    Given the access token is replaced with one that does not contain the scope "network-access-domains:trust-domains"
    When the request "createTrustDomain" is sent
    Then the response status code is 403
    And the response property "$.status" is 403
    And the response property "$.code" is "PERMISSION_DENIED"

  @network_access_domains_createTrustDomain_403_02_read_only_scope @full_tier @requires_oidc
  Scenario: Access token has only the :read-all variant, which does not authorize creation
    ...
    Given the access token is replaced with one whose only NAM scope is "network-access-domains:trust-domains:read-all"
    When the request "createTrustDomain" is sent
    Then the response status code is 403
    And the response property "$.code" is "PERMISSION_DENIED"
  # =====================================================================
