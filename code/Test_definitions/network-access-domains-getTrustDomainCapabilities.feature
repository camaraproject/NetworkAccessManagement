Feature: CAMARA Network Access Domains API, vwip - Operation getTrustDomainCapabilities
  ...
  Background: Common getTrustDomainCapabilities setup
    ...
    And the resource "/network-access-domains/vwip/trust-domains/capabilities"
