Feature: CAMARA Network Access Management API, v0.2.0-alpha.1 - Operation getService
  ...
  Background: Common getService setup
    ...
    And the resource "/network-access-management/v0.2alpha1/services/{serviceId}"
